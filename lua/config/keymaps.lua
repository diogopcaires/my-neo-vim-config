...
-- eca
map("n", "dt", "<cmd>:EcaToggle<CR>", { silent = true, desc = "Eca Toggle" })
map("n", "df", "<cmd>:EcaFocus<CR>", { silent = true, desc = "Eca Focus" })
...
vim.keymap.set("n", "<C-j>", "<C-w><C-j>", { desc = "Move focus to the lower window" })
vim.keymap.set("n", "<leader>ee", "<cmd>EcaToggle<cr>", { desc = "ECA toggle" })
